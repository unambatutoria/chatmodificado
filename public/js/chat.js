        ...
        if(data.type == 'server') {
            switch(data.info) {
                ...
                case 'success':
                    ...
                    updateBar('mdi-content-send', 'Ingresa tu mensaje', false);
                    connected = true;
                ...
                case 'connection':
                    ...
                    showChat('info', null, data.user.un + userip + ' se ah conectado al servidor');
                ...
                case 'disconnection':
                    ...
                    if(data.user.un != null) {
                        showChat('info', null, data.user.un + userip + ' desconectado del servidor');
                    }
